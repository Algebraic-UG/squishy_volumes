...
pub struct CellsToMurmur {
    cells_to_murmur: CompiledModule,
}
...
impl PipelinePart for CellsToMurmur {
    ...
    fn record(
        ...
        let mut compute_pass = encoder.begin_compute_pass(self.cells_to_murmur.label);
        compute_pass.set_pipeline(&self.cells_to_murmur.compute_pipeline);
