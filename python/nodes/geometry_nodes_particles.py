...
def create_geometry_nodes_particles():
    ...
    # initialize blended_mpm_deformed_cubes node group
    def blended_mpm_deformed_cubes_node_group():
        blended_mpm_deformed_cubes = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Deformed Cubes"
        )

        blended_mpm_deformed_cubes.color_tag = "NONE"
        blended_mpm_deformed_cubes.description = ""
        blended_mpm_deformed_cubes.default_group_node_width = 140

        # blended_mpm_deformed_cubes interface
        # Socket Geometry
        geometry_socket = blended_mpm_deformed_cubes.interface.new_socket(
            name="Geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket.attribute_domain = "POINT"

        # Socket Geometry
        geometry_socket_1 = blended_mpm_deformed_cubes.interface.new_socket(
            name="Geometry", in_out="INPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_1.attribute_domain = "POINT"

        # Socket Scale
        scale_socket = blended_mpm_deformed_cubes.interface.new_socket(
        ...
        particle_size_socket = blended_mpm_deformed_cubes.interface.new_socket(
        ...
        # initialize blended_mpm_deformed_cubes nodes
        # node Group Input
        group_input = blended_mpm_deformed_cubes.nodes.new("NodeGroupInput")
        group_input.name = "Group Input"

        # node Math
        math = blended_mpm_deformed_cubes.nodes.new("ShaderNodeMath")
        math.name = "Math"
        ...
        # node Cube
        cube = blended_mpm_deformed_cubes.nodes.new("GeometryNodeMeshCube")
        cube.name = "Cube"
        # Vertices X
        ...
        instance_on_points = blended_mpm_deformed_cubes.nodes.new(
        ...
        named_attribute = blended_mpm_deformed_cubes.nodes.new(
        ...
        set_instance_transform = blended_mpm_deformed_cubes.nodes.new(
        ...
        # node Group Output
        group_output = blended_mpm_deformed_cubes.nodes.new("NodeGroupOutput")
        ...
        # initialize blended_mpm_deformed_cubes links
        # group_input.Geometry -> instance_on_points.Points
        blended_mpm_deformed_cubes.links.new(
            group_input.outputs[0], instance_on_points.inputs[0]
        )
        # group_input.Scale -> math.Value
        blended_mpm_deformed_cubes.links.new(group_input.outputs[1], math.inputs[0])
        # group_input.Particle Size -> math.Value
        blended_mpm_deformed_cubes.links.new(group_input.outputs[2], math.inputs[1])
        # math.Value -> cube.Size
        blended_mpm_deformed_cubes.links.new(math.outputs[0], cube.inputs[0])
        ...
        return blended_mpm_deformed_cubes

    blended_mpm_deformed_cubes = blended_mpm_deformed_cubes_node_group()

    # initialize blended_mpm_color_energy node group
    def blended_mpm_color_energy_node_group():
        blended_mpm_color_energy = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Color Energy"
        )

        blended_mpm_color_energy.color_tag = "NONE"
        blended_mpm_color_energy.description = ""
        blended_mpm_color_energy.default_group_node_width = 140

        # blended_mpm_color_energy interface
        # Socket Instance Color
        instance_color_socket = blended_mpm_color_energy.interface.new_socket(
        ...
        divide_by_10_x_socket = blended_mpm_color_energy.interface.new_socket(
        ...
        # initialize blended_mpm_color_energy nodes
        # node Group Input
        group_input_1 = blended_mpm_color_energy.nodes.new("NodeGroupInput")
        group_input_1.name = "Group Input"

        # node Named Attribute
        named_attribute_1 = blended_mpm_color_energy.nodes.new(
            "GeometryNodeInputNamedAttribute"
        )
        named_attribute_1.name = "Named Attribute"
        named_attribute_1.data_type = "FLOAT"
        # Name
        named_attribute_1.inputs[0].default_value = BLENDED_MPM_ELASTIC_ENERGY

        # node Math
        math_1 = blended_mpm_color_energy.nodes.new("ShaderNodeMath")
        math_1.name = "Math"
        ...
        # node Math.001
        math_001 = blended_mpm_color_energy.nodes.new("ShaderNodeMath")
        ...
        # node Color Ramp
        color_ramp = blended_mpm_color_energy.nodes.new("ShaderNodeValToRGB")
        ...
        # node Group Output
        group_output_1 = blended_mpm_color_energy.nodes.new("NodeGroupOutput")
        ...
        # initialize blended_mpm_color_energy links
        # group_input_1.Divide by 10^x -> math_1.Value
        blended_mpm_color_energy.links.new(group_input_1.outputs[0], math_1.inputs[1])
        # named_attribute_1.Attribute -> math_001.Value
        blended_mpm_color_energy.links.new(
            named_attribute_1.outputs[0], math_001.inputs[0]
        )
        # math_1.Value -> math_001.Value
        blended_mpm_color_energy.links.new(math_1.outputs[0], math_001.inputs[1])
        # math_001.Value -> color_ramp.Fac
        blended_mpm_color_energy.links.new(math_001.outputs[0], color_ramp.inputs[0])
        # color_ramp.Color -> group_output_1.Instance Color
        blended_mpm_color_energy.links.new(
            color_ramp.outputs[0], group_output_1.inputs[0]
        )
        return blended_mpm_color_energy

    blended_mpm_color_energy = blended_mpm_color_energy_node_group()

    # initialize blended_mpm_color_inside node group
    def blended_mpm_color_inside_node_group():
        blended_mpm_color_inside = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Color Inside"
        )

        blended_mpm_color_inside.color_tag = "NONE"
        blended_mpm_color_inside.description = ""
        blended_mpm_color_inside.default_group_node_width = 140

        # blended_mpm_color_inside interface
        # Socket Instance Color
        instance_color_socket_1 = blended_mpm_color_inside.interface.new_socket(
            name="Instance Color", in_out="OUTPUT", socket_type="NodeSocketColor"
        )
        ...
        # Socket Collider Idx
        collider_idx_socket = blended_mpm_color_inside.interface.new_socket(
        ...
        # initialize blended_mpm_color_inside nodes
        # node Group Input
        group_input_2 = blended_mpm_color_inside.nodes.new("NodeGroupInput")
        group_input_2.name = "Group Input"

        # node String
        string = blended_mpm_color_inside.nodes.new("FunctionNodeInputString")
        string.name = "String"
        string.string = BLENDED_MPM_COLLIDER_INSIDE

        # node Value to String
        value_to_string = blended_mpm_color_inside.nodes.new(
        ...
        # node Join Strings
        join_strings = blended_mpm_color_inside.nodes.new("GeometryNodeStringJoin")
        join_strings.name = "Join Strings"
        # Delimiter
        join_strings.inputs[0].default_value = "_"

        # node Named Attribute
        named_attribute_2 = blended_mpm_color_inside.nodes.new(
            "GeometryNodeInputNamedAttribute"
        )
        ...
        # node Math
        math_2 = blended_mpm_color_inside.nodes.new("ShaderNodeMath")
        math_2.name = "Math"
        ...
        # node Math.001
        math_001_1 = blended_mpm_color_inside.nodes.new("ShaderNodeMath")
        ...
        # node Color Ramp
        color_ramp_1 = blended_mpm_color_inside.nodes.new("ShaderNodeValToRGB")
        ...
        # node Group Output
        group_output_2 = blended_mpm_color_inside.nodes.new("NodeGroupOutput")
        ...
        # initialize blended_mpm_color_inside links
        # group_input_2.Collider Idx -> value_to_string.Value
        blended_mpm_color_inside.links.new(
        ...
        blended_mpm_color_inside.links.new(math_2.outputs[0], math_001_1.inputs[0])
        ...
        blended_mpm_color_inside.links.new(string.outputs[0], join_strings.inputs[1])
        return blended_mpm_color_inside

    blended_mpm_color_inside = blended_mpm_color_inside_node_group()
    ...
    def blended_mpm_color_instance_node_group():
        ...
        # Socket Geometry
        geometry_socket_2 = blended_mpm_color_instance.interface.new_socket(
            name="Geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_2.attribute_domain = "POINT"

        # Socket Geometry
        geometry_socket_3 = blended_mpm_color_instance.interface.new_socket(
            name="Geometry", in_out="INPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_3.attribute_domain = "POINT"

        # Socket Instance Color
        instance_color_socket_2 = blended_mpm_color_instance.interface.new_socket(
        ...
        # node Group Input
        group_input_3 = blended_mpm_color_instance.nodes.new("NodeGroupInput")
        ...
        # node Group Output
        group_output_3 = blended_mpm_color_instance.nodes.new("NodeGroupOutput")
    ...
    # initialize blended_mpm_color_particle node group
    def blended_mpm_color_particle_node_group():
        blended_mpm_color_particle = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Color Particle"
        )

        blended_mpm_color_particle.color_tag = "NONE"
        blended_mpm_color_particle.description = ""
        blended_mpm_color_particle.default_group_node_width = 140

        # blended_mpm_color_particle interface
        # Socket Geometry
        geometry_socket_4 = blended_mpm_color_particle.interface.new_socket(
            name="Geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_4.attribute_domain = "POINT"

        # Socket Geometry
        geometry_socket_5 = blended_mpm_color_particle.interface.new_socket(
            name="Geometry", in_out="INPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_5.attribute_domain = "POINT"

        # Socket Coloring
        coloring_socket = blended_mpm_color_particle.interface.new_socket(
            name="Coloring", in_out="INPUT", socket_type="NodeSocketMenu"
        )
        coloring_socket.attribute_domain = "POINT"

        # Socket Divide by 10^x
        divide_by_10_x_socket_1 = blended_mpm_color_particle.interface.new_socket(
            name="Divide by 10^x", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # Socket Collider Idx
        collider_idx_socket_1 = blended_mpm_color_particle.interface.new_socket(
            name="Collider Idx", in_out="INPUT", socket_type="NodeSocketInt"
        )
        ...
        # initialize blended_mpm_color_particle nodes
        # node Group Input
        group_input_4 = blended_mpm_color_particle.nodes.new("NodeGroupInput")
        group_input_4.name = "Group Input"

        # node Group
        group = blended_mpm_color_particle.nodes.new("GeometryNodeGroup")
        group.name = "Group"
        group.node_tree = blended_mpm_color_energy

        # node Group.001
        group_001 = blended_mpm_color_particle.nodes.new("GeometryNodeGroup")
        group_001.name = "Group.001"
        group_001.node_tree = blended_mpm_color_inside

        # node Menu Switch
        menu_switch = blended_mpm_color_particle.nodes.new("GeometryNodeMenuSwitch")
        ...
        # node Group.002
        group_002 = blended_mpm_color_particle.nodes.new("GeometryNodeGroup")
        group_002.name = "Group.002"
        group_002.node_tree = blended_mpm_color_instance

        # node Group Output
        group_output_4 = blended_mpm_color_particle.nodes.new("NodeGroupOutput")
        ...
        # initialize blended_mpm_color_particle links
        # group_input_4.Geometry -> group_002.Geometry
        blended_mpm_color_particle.links.new(
            group_input_4.outputs[0], group_002.inputs[0]
        )
        # group_input_4.Divide by 10^x -> group.Divide by 10^x
        blended_mpm_color_particle.links.new(group_input_4.outputs[2], group.inputs[0])
        ...
        blended_mpm_color_particle.links.new(group.outputs[0], menu_switch.inputs[1])
        ...
        return blended_mpm_color_particle

    blended_mpm_color_particle = blended_mpm_color_particle_node_group()
    ...
    # initialize blended_mpm_reconstruct node group
    def blended_mpm_reconstruct_node_group():
        blended_mpm_reconstruct = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Reconstruct"
        )

        blended_mpm_reconstruct.color_tag = "NONE"
        blended_mpm_reconstruct.description = ""
        blended_mpm_reconstruct.default_group_node_width = 140

        # blended_mpm_reconstruct interface
        # Socket Geometry
        geometry_socket_8 = blended_mpm_reconstruct.interface.new_socket(
            name="Geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_8.attribute_domain = "POINT"

        # Socket Geometry
        geometry_socket_9 = blended_mpm_reconstruct.interface.new_socket(
            name="Geometry", in_out="INPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_9.attribute_domain = "POINT"

        # Socket Particle Size
        particle_size_socket_1 = blended_mpm_reconstruct.interface.new_socket(
            name="Particle Size", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # Socket Threshold
        threshold_socket = blended_mpm_reconstruct.interface.new_socket(
        ...
        # Socket Material
        material_socket = blended_mpm_reconstruct.interface.new_socket(
            name="Material", in_out="INPUT", socket_type="NodeSocketMaterial"
        )
        material_socket.attribute_domain = "POINT"

        # initialize blended_mpm_reconstruct nodes
        # node Group Input
        group_input_6 = blended_mpm_reconstruct.nodes.new("NodeGroupInput")
        group_input_6.name = "Group Input"

        # node Math
        math_4 = blended_mpm_reconstruct.nodes.new("ShaderNodeMath")
        math_4.name = "Math"
        ...
        points_to_volume = blended_mpm_reconstruct.nodes.new(
        ...
        # node Volume to Mesh
        volume_to_mesh = blended_mpm_reconstruct.nodes.new("GeometryNodeVolumeToMesh")
        ...
        # node Set Material
        set_material_1 = blended_mpm_reconstruct.nodes.new("GeometryNodeSetMaterial")
        set_material_1.name = "Set Material"
        # Selection
        set_material_1.inputs[1].default_value = True

        # node Group Output
        group_output_6 = blended_mpm_reconstruct.nodes.new("NodeGroupOutput")
        ...
        # initialize blended_mpm_reconstruct links
        # group_input_6.Geometry -> points_to_volume.Points
        blended_mpm_reconstruct.links.new(
            group_input_6.outputs[0], points_to_volume.inputs[0]
        )
        # group_input_6.Particle Size -> math_4.Value
        blended_mpm_reconstruct.links.new(group_input_6.outputs[1], math_4.inputs[0])
        ...
        blended_mpm_reconstruct.links.new(math_4.outputs[0], points_to_volume.inputs[4])
        ...
        return blended_mpm_reconstruct

    blended_mpm_reconstruct = blended_mpm_reconstruct_node_group()

    # initialize blended_mpm_particle node group
    def blended_mpm_particle_node_group():
        blended_mpm_particle = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Particle"
        )

        blended_mpm_particle.color_tag = "NONE"
        blended_mpm_particle.description = ""
        blended_mpm_particle.default_group_node_width = 140

        blended_mpm_particle.is_modifier = True

        # blended_mpm_particle interface
        # Socket Geometry
        geometry_socket_10 = blended_mpm_particle.interface.new_socket(
            name="Geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_10.attribute_domain = "POINT"

        # Socket Geometry
        geometry_socket_11 = blended_mpm_particle.interface.new_socket(
            name="Geometry", in_out="INPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_11.attribute_domain = "POINT"

        # Socket Display as
        display_as_socket = blended_mpm_particle.interface.new_socket(
            name="Display as", in_out="INPUT", socket_type="NodeSocketMenu"
        )
        display_as_socket.attribute_domain = "POINT"

        # Socket Coloring
        coloring_socket_1 = blended_mpm_particle.interface.new_socket(
            name="Coloring", in_out="INPUT", socket_type="NodeSocketMenu"
        )
        coloring_socket_1.attribute_domain = "POINT"

        # Socket Divide by 10^x
        divide_by_10_x_socket_2 = blended_mpm_particle.interface.new_socket(
            name="Divide by 10^x", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # Socket Collider Idx
        collider_idx_socket_2 = blended_mpm_particle.interface.new_socket(
            name="Collider Idx", in_out="INPUT", socket_type="NodeSocketInt"
        )
        ...
        # Socket Scale
        scale_socket_2 = blended_mpm_particle.interface.new_socket(
            name="Scale", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        velocity_scale_socket = blended_mpm_particle.interface.new_socket(
        ...
        # Socket Particle Size
        particle_size_socket_2 = blended_mpm_particle.interface.new_socket(
            name="Particle Size", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # Socket Threshold
        threshold_socket_1 = blended_mpm_particle.interface.new_socket(
            name="Threshold", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # Socket Material
        material_socket_1 = blended_mpm_particle.interface.new_socket(
            name="Material", in_out="INPUT", socket_type="NodeSocketMaterial"
        )
        material_socket_1.attribute_domain = "POINT"

        # initialize blended_mpm_particle nodes
        # node Group Input
        group_input_7 = blended_mpm_particle.nodes.new("NodeGroupInput")
        group_input_7.name = "Group Input"

        # node Group
        group_1 = blended_mpm_particle.nodes.new("GeometryNodeGroup")
        group_1.name = "Group"
        group_1.node_tree = blended_mpm_deformed_cubes

        # node Group.001
        group_001_1 = blended_mpm_particle.nodes.new("GeometryNodeGroup")
        group_001_1.name = "Group.001"
        group_001_1.node_tree = blended_mpm_color_particle

        # node Named Attribute
        named_attribute_3 = blended_mpm_particle.nodes.new(
            "GeometryNodeInputNamedAttribute"
        )
        named_attribute_3.name = "Named Attribute"
        named_attribute_3.data_type = "FLOAT_VECTOR"
        # Name
        named_attribute_3.inputs[0].default_value = BLENDED_MPM_VELOCITY

        # node Group.002
        group_002_1 = blended_mpm_particle.nodes.new("GeometryNodeGroup")
        group_002_1.name = "Group.002"
        group_002_1.node_tree = blended_mpm_vector

        # node Group.003
        group_003 = blended_mpm_particle.nodes.new("GeometryNodeGroup")
        group_003.name = "Group.003"
        group_003.node_tree = blended_mpm_reconstruct

        # node Join Geometry
        join_geometry = blended_mpm_particle.nodes.new("GeometryNodeJoinGeometry")
        join_geometry.name = "Join Geometry"

        # node Menu Switch
        menu_switch_1 = blended_mpm_particle.nodes.new("GeometryNodeMenuSwitch")
        ...
        # node Group Output
        group_output_7 = blended_mpm_particle.nodes.new("NodeGroupOutput")
        ...
        # initialize blended_mpm_particle links
        # group_input_7.Geometry -> group_1.Geometry
        blended_mpm_particle.links.new(group_input_7.outputs[0], group_1.inputs[0])
        # group_input_7.Geometry -> group_002_1.Geometry
        blended_mpm_particle.links.new(group_input_7.outputs[0], group_002_1.inputs[0])
        # group_input_7.Geometry -> group_003.Geometry
        blended_mpm_particle.links.new(group_input_7.outputs[0], group_003.inputs[0])
        # group_input_7.Display as -> menu_switch_1.Menu
        blended_mpm_particle.links.new(
            group_input_7.outputs[1], menu_switch_1.inputs[0]
        )
        # group_input_7.Coloring -> group_001_1.Coloring
        blended_mpm_particle.links.new(group_input_7.outputs[2], group_001_1.inputs[1])
        # group_input_7.Divide by 10^x -> group_001_1.Divide by 10^x
        blended_mpm_particle.links.new(group_input_7.outputs[3], group_001_1.inputs[2])
        # group_input_7.Collider Idx -> group_001_1.Collider Idx
        blended_mpm_particle.links.new(group_input_7.outputs[4], group_001_1.inputs[3])
        # group_input_7.Scale -> group_1.Scale
        blended_mpm_particle.links.new(group_input_7.outputs[5], group_1.inputs[1])
        # group_input_7.Velocity Scale -> group_002_1.Scale
        blended_mpm_particle.links.new(group_input_7.outputs[6], group_002_1.inputs[2])
        # group_input_7.Particle Size -> group_1.Particle Size
        blended_mpm_particle.links.new(group_input_7.outputs[7], group_1.inputs[2])
        # group_input_7.Particle Size -> group_003.Particle Size
        blended_mpm_particle.links.new(group_input_7.outputs[7], group_003.inputs[1])
        # group_input_7.Threshold -> group_003.Threshold
        blended_mpm_particle.links.new(group_input_7.outputs[8], group_003.inputs[2])
        # group_input_7.Material -> group_003.Material
        blended_mpm_particle.links.new(group_input_7.outputs[9], group_003.inputs[3])
        # group_1.Geometry -> group_001_1.Geometry
        blended_mpm_particle.links.new(group_1.outputs[0], group_001_1.inputs[0])
        ...
        blended_mpm_particle.links.new(group_002_1.outputs[0], join_geometry.inputs[0])
        ...
        blended_mpm_particle.links.new(group_003.outputs[0], menu_switch_1.inputs[2])
        ...
        blended_mpm_particle.links.new(group_001_1.outputs[0], join_geometry.inputs[0])
        display_as_socket.default_value = "Deformed Cubes"
        coloring_socket_1.default_value = "Energy"
        return blended_mpm_particle

    return blended_mpm_particle_node_group()
