...
def create_geometry_nodes_grid_distance():
    ...
    # initialize blended_mpm_read_distance node group
    def blended_mpm_read_distance_node_group():
        blended_mpm_read_distance = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Read Distance"
        )

        blended_mpm_read_distance.color_tag = "NONE"
        blended_mpm_read_distance.description = ""
        blended_mpm_read_distance.default_group_node_width = 140

        # blended_mpm_read_distance interface
        # Socket Distance
        distance_socket = blended_mpm_read_distance.interface.new_socket(
        ...
        # Socket Normal
        normal_socket = blended_mpm_read_distance.interface.new_socket(
        ...
        # Socket Collider Idx
        collider_idx_socket = blended_mpm_read_distance.interface.new_socket(
        ...
        # initialize blended_mpm_read_distance nodes
        # node Group Output
        group_output_3 = blended_mpm_read_distance.nodes.new("NodeGroupOutput")
        group_output_3.name = "Group Output"
        group_output_3.is_active_output = True

        # node Group Input
        group_input_3 = blended_mpm_read_distance.nodes.new("NodeGroupInput")
        group_input_3.name = "Group Input"

        # node Join Strings
        join_strings = blended_mpm_read_distance.nodes.new("GeometryNodeStringJoin")
        join_strings.name = "Join Strings"
        # Delimiter
        join_strings.inputs[0].default_value = "_"

        # node String
        string = blended_mpm_read_distance.nodes.new("FunctionNodeInputString")
        string.name = "String"
        string.string = BLENDED_MPM_DISTANCE

        # node Named Attribute
        named_attribute = blended_mpm_read_distance.nodes.new(
        ...
        join_strings_001 = blended_mpm_read_distance.nodes.new("GeometryNodeStringJoin")
        join_strings_001.name = "Join Strings.001"
        # Delimiter
        join_strings_001.inputs[0].default_value = "_"

        # node String.001
        string_001 = blended_mpm_read_distance.nodes.new("FunctionNodeInputString")
        string_001.name = "String.001"
        string_001.string = BLENDED_MPM_NORMAL

        # node Named Attribute.001
        named_attribute_001 = blended_mpm_read_distance.nodes.new(
            "GeometryNodeInputNamedAttribute"
        )
        ...
        value_to_string = blended_mpm_read_distance.nodes.new(
        ...
        # initialize blended_mpm_read_distance links
        # join_strings_001.String -> named_attribute_001.Name
        blended_mpm_read_distance.links.new(
        ...
        blended_mpm_read_distance.links.new(string.outputs[0], join_strings.inputs[1])
        return blended_mpm_read_distance

    blended_mpm_read_distance = blended_mpm_read_distance_node_group()

    # initialize blended_mpm_grid_distance node group
    def blended_mpm_grid_distance_node_group():
        blended_mpm_grid_distance = bpy.data.node_groups.new(
            type="GeometryNodeTree", name="Blended MPM Grid Distance"
        )

        blended_mpm_grid_distance.color_tag = "NONE"
        blended_mpm_grid_distance.description = ""
        blended_mpm_grid_distance.default_group_node_width = 140

        blended_mpm_grid_distance.is_modifier = True

        # blended_mpm_grid_distance interface
        # Socket Geometry
        geometry_socket_4 = blended_mpm_grid_distance.interface.new_socket(
            name="Geometry", in_out="OUTPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_4.attribute_domain = "POINT"

        # Socket Geometry
        geometry_socket_5 = blended_mpm_grid_distance.interface.new_socket(
            name="Geometry", in_out="INPUT", socket_type="NodeSocketGeometry"
        )
        geometry_socket_5.attribute_domain = "POINT"

        # Socket Collider Idx
        collider_idx_socket_1 = blended_mpm_grid_distance.interface.new_socket(
            name="Collider Idx", in_out="INPUT", socket_type="NodeSocketInt"
        )
        ...
        # Socket Scale
        scale_socket_2 = blended_mpm_grid_distance.interface.new_socket(
            name="Scale", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # Socket Normal Scale
        normal_scale_socket = blended_mpm_grid_distance.interface.new_socket(
        ...
        # Socket Grid Node Size
        grid_node_size_socket_1 = blended_mpm_grid_distance.interface.new_socket(
            name="Grid Node Size", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # initialize blended_mpm_grid_distance nodes
        # node Group Output
        group_output_4 = blended_mpm_grid_distance.nodes.new("NodeGroupOutput")
        group_output_4.name = "Group Output"
        group_output_4.is_active_output = True

        # node Group
        group = blended_mpm_grid_distance.nodes.new("GeometryNodeGroup")
        group.name = "Group"
        group.node_tree = blended_mpm_color_instance

        # node Math
        math_1 = blended_mpm_grid_distance.nodes.new("ShaderNodeMath")
        math_1.name = "Math"
        ...
        # node Math.001
        math_001 = blended_mpm_grid_distance.nodes.new("ShaderNodeMath")
        math_001.name = "Math.001"
        math_001.operation = "DIVIDE"
        math_001.use_clamp = False

        # node Math.006
        math_006 = blended_mpm_grid_distance.nodes.new("ShaderNodeMath")
        ...
        # node Color Ramp
        color_ramp = blended_mpm_grid_distance.nodes.new("ShaderNodeValToRGB")
        ...
        # node Group.002
        group_002 = blended_mpm_grid_distance.nodes.new("GeometryNodeGroup")
        group_002.name = "Group.002"
        group_002.node_tree = blended_mpm_vector

        # node Join Geometry
        join_geometry = blended_mpm_grid_distance.nodes.new("GeometryNodeJoinGeometry")
        join_geometry.name = "Join Geometry"

        # node Delete Geometry
        delete_geometry = blended_mpm_grid_distance.nodes.new(
        ...
        # node Math.002
        math_002 = blended_mpm_grid_distance.nodes.new("ShaderNodeMath")
        ...
        # node Group.001
        group_001 = blended_mpm_grid_distance.nodes.new("GeometryNodeGroup")
        group_001.name = "Group.001"
        group_001.node_tree = blended_mpm_crystal_grid

        # node Group.003
        group_003 = blended_mpm_grid_distance.nodes.new("GeometryNodeGroup")
        group_003.name = "Group.003"
        group_003.node_tree = blended_mpm_read_distance

        # node Group Input.002
        group_input_002 = blended_mpm_grid_distance.nodes.new("NodeGroupInput")
        group_input_002.name = "Group Input.002"

        # node Reroute
        reroute = blended_mpm_grid_distance.nodes.new("NodeReroute")
        reroute.name = "Reroute"
        reroute.socket_idname = "NodeSocketGeometry"
        # node Reroute.001
        reroute_001 = blended_mpm_grid_distance.nodes.new("NodeReroute")
        reroute_001.name = "Reroute.001"
        reroute_001.socket_idname = "NodeSocketFloat"
        # node Group Input.001
        group_input_001 = blended_mpm_grid_distance.nodes.new("NodeGroupInput")
        group_input_001.name = "Group Input.001"

        # node Reroute.003
        reroute_003 = blended_mpm_grid_distance.nodes.new("NodeReroute")
        ...
        # initialize blended_mpm_grid_distance links
        # join_geometry.Geometry -> group_output_4.Geometry
        blended_mpm_grid_distance.links.new(
            join_geometry.outputs[0], group_output_4.inputs[0]
        )
        # math_001.Value -> math_1.Value
        blended_mpm_grid_distance.links.new(math_001.outputs[0], math_1.inputs[0])
        # math_006.Value -> math_001.Value
        blended_mpm_grid_distance.links.new(math_006.outputs[0], math_001.inputs[1])
        ...
        blended_mpm_grid_distance.links.new(math_1.outputs[0], color_ramp.inputs[0])
        # group_001.Instances -> group.Geometry
        blended_mpm_grid_distance.links.new(group_001.outputs[0], group.inputs[0])
        # color_ramp.Color -> group.Instance Color
        blended_mpm_grid_distance.links.new(color_ramp.outputs[0], group.inputs[1])
        # reroute.Output -> group_001.Geometry
        blended_mpm_grid_distance.links.new(reroute.outputs[0], group_001.inputs[0])
        # group_003.Distance -> math_002.Value
        blended_mpm_grid_distance.links.new(group_003.outputs[0], math_002.inputs[0])
        ...
        blended_mpm_grid_distance.links.new(reroute_001.outputs[0], group_002.inputs[2])
        ...
        blended_mpm_grid_distance.links.new(group_003.outputs[1], group_002.inputs[1])
        ...
        blended_mpm_grid_distance.links.new(group_003.outputs[0], math_001.inputs[0])
        ...
        blended_mpm_grid_distance.links.new(group.outputs[0], join_geometry.inputs[0])
        return blended_mpm_grid_distance

    return blended_mpm_grid_distance_node_group()
